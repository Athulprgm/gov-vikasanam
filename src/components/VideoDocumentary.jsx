...
export default function VideoDocumentary() {
  ...
  const videoWidth = useTransform(scrollYProgress, [0.1, 0.45], ["60%", "100%"]);
  ...
  return (
    <section
      ref={containerRef}
      id="video-section"
      className="relative min-h-[120vh] bg-[#0B0B0B] flex items-center justify-center overflow-hidden"
    >
      <div className="absolute inset-0 bg-gradient-to-b from-[#0B0B0B] via-transparent to-[#0B0B0B] z-10 pointer-events-none" />
      ...
      <div className="w-full flex flex-col items-center relative z-20">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center mb-16">
          <span className="text-xs uppercase tracking-widest text-[#4CFF9B] font-mono font-bold block mb-3 animate-pulse">
            Cinematic Proof
          </span>
        ...
        <motion.div
          ...
          className="relative aspect-[16/9] max-w-7xl mx-auto overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)] border border-white/5 bg-[#151515]"
        >
          {/* Overlay Grid lines for high tech hud look */}
          <div className="absolute inset-0 bg-grid-white/[0.01] pointer-events-none z-10" />
          ...
          <motion.div
            ...
            className="absolute inset-0 z-20 flex flex-col items-center justify-center p-6 text-center text-[#F5F5F5]"
          >
            ...
            <p className="text-xs sm:text-sm font-mono text-[#4CFF9B] tracking-[0.2em] uppercase">
          ...
          <div className="absolute bottom-6 right-6 z-30 flex items-center space-x-3">
            ...
            <button
              onClick={togglePlay}
              className="p-3 rounded-full bg-black/60 backdrop-blur-md border border-white/10 text-white hover:text-[#4CFF9B] hover:scale-105 transition-all focus:outline-none"
          ...
          {/* HUD framing corners */}
          <div className="absolute top-6 left-6 z-30 text-[9px] font-mono text-white/50 pointer-events-none">
